...
This privacy policy applies to the Mental Math Practice app (hereby referred to as "Application") for mobile devices that was created by Simeon Ivanov (hereby referred to as "Service Provider") as an Ad Supported service. This service is intended for use "AS IS".
...
If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at dev.grayscale@gmail.com.
